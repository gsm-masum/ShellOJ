...
function custom_copy($src, $dst) {  
    ...
    echo $msg;
        ...
        $sql = "INSERT INTO `submission` (`submission_time`, `user`, `problem_name`, `language`, `verdict`, `running_time`, `memory`, `submission_id`, `solution_name`) VALUES ('$submission_time', '$user', '$problem_name', '$language', '$verdict', '$running_time', '$memory', '$user_name', '$solution_name')";
        ...
        // $data = file('source/verdict.txt');
        // $verdict= $data[0];
        // $running_time= $data[1]." ms";
        // $memory= $data[2]." KB";
        //echo "$a\n";

        $sql = "UPDATE `submission` SET `verdict` = '$verdict', `running_time` = '$running_time', `memory` = '$memory' WHERE submission_time = '".$submission_time."'";
        ...
        //del(); 
        echo "true";
            //@rmdir($destination."res/");
            deleteAll("userSubmission/$user_name/res/");
            //@rmdir($destination."test/");
